...
console.log(name)
var name = "Srishti"
// variables are scanned and made undefined so access them before initializing will give the value as undefined. 
...
console.log(name)   // due to local scope this will print undefined. 
